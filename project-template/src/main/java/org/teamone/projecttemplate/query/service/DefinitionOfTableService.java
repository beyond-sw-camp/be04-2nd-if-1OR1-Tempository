...
public class DefinitionOfTableService {
    ...
    public List<DefinitionOfTable> selectAllDefinitionOfTables(org.teamone.projecttemplate.query.dto.DefinitionOfTableDTO definitionDTO) {
    ...
    public List<DefinitionOfTable> selectTableByName(org.teamone.projecttemplate.query.dto.DefinitionOfTableDTO definitionDTO) {
